...
@extends('layout')
@section('content')
@include('category-label',['category'=> $post->category])

<section class="px-6 py-8">
        <main class="max-w-6xl mx-auto mt-10 lg:mt-20 space-y-6">
            <article class="max-w-4xl mx-auto lg:grid lg:grid-cols-12 gap-x-10">
                <div class="col-span-4 lg:text-center lg:pt-14 mb-10">
                    <img src="/Laravel-From-Scratch-HTML-CSS/images/images/illustration-1.png" alt="" class="rounded-xl">
                ...
                <div class="col-span-8">
                    ...
                    <h2 class="space-y-4 lg:text-lg leading-loose ">
                    ...
                    <h5 class="space-y-4 lg:text-lg leading-loose">
                      {{ $post->body }}
                    </h5>
                </div>
            </article>
